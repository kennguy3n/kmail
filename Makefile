.PHONY: build test cover lint fmt vet tidy docker-build clean help migrate bench e2e scim-test helm-lint helm-template helm-sync-dashboards helm-check-dashboards loadtest chaos screenshots
