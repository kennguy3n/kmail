...
Cross-compile sweeps for iOS and Android land in follow-up PRs
that wire the XCFramework and AAR bundling into CI. The napi
multi-target sweep is live as of this PR.
