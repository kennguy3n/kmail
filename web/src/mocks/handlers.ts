...
// Seed realistic demo notes so the shared-inbox detail panel is not empty
// in showcase screenshots.
sharedInboxNotes.set(noteKey("shared-support", "msg-2"), [
  {
    id: "note-seed-1",
    author_user_id: "alice",
    note_text: "Reached out to Finance for the latest Q2 numbers. Waiting for reply.",
    created_at: relPast(45 * 60),
  },
  {
    id: "note-seed-2",
    author_user_id: "demo",
    note_text: "Schedule follow-up standup once the spreadsheet lands.",
    created_at: relPast(30 * 60),
  },
]);
...
export const handlers = [
    ...
    HttpResponse.json({
      shares: [
        ...
        },
        {
          ...
          target_name: "Demo Admin",
          permission: "read",
          created_at: relPast(12 * 24 * 60 * 60),
        },
        {
          id: "share-3",
          tenant_id: TENANT_ID,
          calendar_id: "cal-team",
          calendar_name: "Engineering team",
          owner_account_id: ACCOUNT_ID,
          owner_name: "Demo Admin",
          target_account_id: "acct-team",
          target_name: "Engineering group",
          permission: "admin",
          created_at: relPast(3 * 24 * 60 * 60),
        },
      ],
    }),
  ),
  ...
  http.get("/api/v1/secure/:token", () =>
    HttpResponse.json({
      ...
      created_at: relPast(2 * 60 * 60),
      subject: "Confidential: M&A draft",
      body: "Hi team,\n\nPlease find the latest M&A draft attached. This message is confidential and will expire in 7 days.\n\n— Cara",
      body_html: "<p>Hi team,</p><p>Please find the latest M&A draft attached. This message is confidential and will expire in 7 days.</p><p>— Cara</p>",
    }),
  ),
        ...
        assignments: [
          {
            ...
            status: "in_progress",
            created_at: relPast(2 * 60 * 60),
            updated_at: relPast(30 * 60),
            subject: "Q2 Budget Review",
            sender_name: "Alice Nguyen",
            sender_email: "alice@acme.com",
            preview: "Numbers from Finance are in. Quick sync tomorrow at 10am to lock the Q2 ask?",
          },
          {
            id: "asg-2",
            inbox_id: "shared-support",
            ...
            updated_at: relPast(6 * 60 * 60),
            subject: "Confidential: M&A draft",
            sender_name: "Cara Patel",
            sender_email: "cara@acme.com",
            preview: "Encrypted in KChat. Open the secure portal to view this message.",
          },
          {
            id: "asg-3",
            inbox_id: "shared-support",
            ...
            status: "waiting",
            created_at: relPast(24 * 60 * 60),
            updated_at: relPast(2 * 60 * 60),
            subject: "Customer feedback — Q1 wrap",
            sender_name: "Diego Ramos",
            sender_email: "diego@acme.com",
            preview: "Top three themes from the customer survey, plus the verbatim quotes Marketing wanted.",
          },
          {
            id: "asg-4",
            inbox_id: "shared-support",
            email_id: "msg-7",
            assignee_user_id: "erin",
            status: "resolved",
            created_at: relPast(3 * 24 * 60 * 60),
            updated_at: relPast(4 * 60 * 60),
            subject: "Re: Hiring update — backend platform",
            sender_name: "Erin Walsh",
            sender_email: "erin@acme.com",
            preview: "Made an offer to the senior platform candidate. Verbal accept this morning.",
          },
        ],
      }),
  ),
